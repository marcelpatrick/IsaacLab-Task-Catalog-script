...
* Have an Anaconda Python virtual environment created
* Have the original IsaacLab project from NVIDIA cloned to your local machine: https://github.com/isaac-sim/IsaacLab 
* Have an external project created with the Project Creator Wizard in your local machine: https://github.com/marcelpatrick/create-a-new-external-isaaclab-project/blob/main/README.md 
